...
![Setup Repeater](./images/setup-repeater.png)
...
![Registration](./images/wireless-registration.png)
...
![Disabled DHCP Server](./images/disabled-dhcp-server.png)
...
![Bridge Ports](./images/repeater-bridge-ports.png)